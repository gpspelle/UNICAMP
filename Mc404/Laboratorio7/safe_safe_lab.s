...
calc_pascal:
    ...
    cmp r7, r4          @ apenas o ultimo numero nao precisa ser atualizado
    beq end_calc_pascal @ termina a atualizacao 

    mov r3, r7
    mov r3, r3, lsl #2
    ldr r6, [r10, r3]   @ carrega em r6 o a posicao do vetor r10 acima 
   
    add r7, r7, #1 
    mov r3, r7
    mov r3, r3, lsl #2

    ldr r5, [r10, r3]       @ carrega em r5 a posicao do vetor r10 de tras 

    add r5, r5, r6      @ r5 = r5 + r6

    str r5, [r11, r7, lsl #2]   @ atualiza a posicao de r11 
    b calc_pascal
end_calc_pascal:
...
print_loop:
    ...
    ldr r2, [r11, r3]   @ caso contrario, adiciono um ' '
