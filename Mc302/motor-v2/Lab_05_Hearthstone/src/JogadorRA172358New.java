 ...
 */
public class JogadorRA172358New extends Jogador {
     ...
     */
    public JogadorRA172358New(ArrayList<Carta> maoInicial, boolean primeiro){
    ...
    public ArrayList<Jogada> processarTurno (Mesa mesa, Carta cartaComprada, ArrayList<Jogada> jogadasOponente){
        ...
        for(int i = 0; i < mao.size() && !magic; i++) {
            ...
            if(card instanceof CartaMagia && card.getMana() <= minhaMana) {
                ...
                else if(((CartaMagia) card).getMagiaTipo() == TipoMagia.ALVO && ((CartaMagia) card).getMagiaDano() >= mesa.getVidaHeroi2()) {
                    Jogada lac = new Jogada(TipoJogada.MAGIA, card, null);
                    minhasJogadas.add(lac);
                    minhaMana -= card.getMana();
                    System.out.println("Jogada: Decidi uma jogada de atacar com a magia: " + card);
        ...
        if(minhaMana >= 2) {
            ...
            minhasJogadas.add(lac);
            System.out.println("Jogada: Decidi uma jogada de atacar com o poder heroico o heroi inimigo");
        }
